...
def get_calories(fruit):
    fruit_list = {"apple": 130, "avocado": 50, "banana": 110, "cantaloupe": 50, "grapefruit": 60, "grapes": 90, "honeydew melon": 50, "kiwifruit": 90, "lemon": 15, "lime": 20,
    ...
    if fruit.lower() in fruit_list:
        print("Calories:", fruit_list[fruit.lower()])
